...
$pyjs['loaded_modules']['piscorebeta'] = function (__mod_name__) {
	...
	$m['setup'] = function() {
		var x,y,font_size,font_colour,clock,text,screen,background,linefirst,$add17,bg_col,font_path,mainloop,FPS,$div3,font,$add18,textpos,$div4;
		$m['pygame']['init']();
		...
		x = 40;
		y = 30;
		linefirst = $m['write']($p['__op_add']($add17=$p['chr'](960),$add18='=3.'), $m['fontObj']);
		screen['blit'](linefirst, $p['tuple']([x, y]));
	...
	$m['run'] = function() {
		var line_len,$or1,$iter6_idx,line_num,$iter6_type,key2,key1,$or2,$iter6_array,mainloop,$mul6,$iter6_iter,$mul5,event,$iter6_nextval;
		line_len = 5;
		line_num = 4;
